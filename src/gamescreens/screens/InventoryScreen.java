...
//    private Item[] bearEquipped = new Item[6];
    ...
    public InventoryScreen(ScreenManager screenManager) {
        super(screenManager, "InventoryScreen");
        isExclusive = true;
//
...
//        bearEquipped[3] = inv.getWeapon(2);
    ...
    protected void initializeScreen() {
        addObject(new ImageContainer(xValBG, yValBG, "/assets/backgrounds/BG-Inventory.png", DrawLayer.Background));
        addObject(new ImageContainer(30,20, "/assets/Teddy.png", DrawLayer.Background));
    }
...
//    }
    ...
    @Override
    protected void transitionOn() { currentState = ScreenState.Active; }

    @Override
    protected void transitionOff() { exiting = true; }
